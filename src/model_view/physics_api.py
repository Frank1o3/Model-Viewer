...
async def compute_soft_body_physics(request: SoftBodyRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Physics computation failed: {str(e)}")
...
async def compute_spring_bones(request: SpringBoneRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Spring bone computation failed: {str(e)}")
...
async def advanced_paint_physics(request: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Paint computation failed: {str(e)}")
